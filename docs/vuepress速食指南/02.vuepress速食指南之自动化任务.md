...
> 完成上面的工作后，你已经成功为你的 blog 构建了一套自动化工作流程，有没有觉得很棒呢，哈哈ha。那么现在开始，再为你的 blog 添砖加瓦， 通过 npm scripts 编写出专属于你自己的工作流吧！
